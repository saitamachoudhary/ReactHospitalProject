...
const Loginright=()=>{
    return (
        <div style={{height:'',width:'40vw',backgroundColor:"#3758F9",padding:'20px 20px'}}>
          ...
          <img style={{width:'550px'}} src="src\Component\Images\—Pngtree—dasabled people and smart medical_6601162 1.png" alt="" />
          </div>
          <div>
            <h1 style={{color:'white',textAlign:'left',fontWeight:'300',fontSize:'40px',fontStyle:'italic'}}>Enhance impact in healthcare</h1>
